...
class SimpleDBClass
{
  ...
  public function __construct( $db_conn = array('host' => 'localhost', 'user' => 'dotcomgr_user','pass' => 'DotcomUserPass1','database' => 'dotcomgr_grc', ) )
  {
    $host = isset($db_conn['host']) ? $db_conn['host'] : 'localhost' ;
    $user = isset($db_conn['user']) ? $db_conn['user'] : 'dotcomgr_user' ;
    $pass = isset($db_conn['pass']) ? $db_conn['pass'] : 'DotcomUserPass1' ;
